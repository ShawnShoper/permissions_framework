...
Dates.iswrite = function(){
    ...
    var laydate_btn_time = document.getElementsByClassName('laydate_btn')[0];
    if(Dates.options.istime){
        if(!Dates.hasClass(laydate_btn_time, 'laydate_btn_time')){
            Dates.addClass(laydate_btn_time, 'laydate_btn_time');
        }
    }else{
       if(Dates.hasClass(laydate_btn_time, 'laydate_btn_time')){
            Dates.removeClass(laydate_btn_time, 'laydate_btn_time');
        }
    }
...
Dates.creation = function(ymd, hide){
    ...
    if(!Dates.hasClass(Dates.elem, 'active')){
        Dates.addClass(Dates.elem, 'active');
    }else{
        Dates.removeClass(Dates.elem, 'active');
    }
    if(!hide){
        Dates.close();
